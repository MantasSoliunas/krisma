<section class="footer-main">
        <div class="flex-between">
            <div class="who">
                <h2>APIE MUS</h2>
                <a href="../../public/lt/pradinis.php"><img src="../../app/img/logo_white.png" alt="Krisma logo" width="161px"></a>
                ...
                <a href="../../public/lt/apie.php"><strong>Daugiau apie mus<i class="bi bi-arrow-right"></i></strong></a>
            </div>
